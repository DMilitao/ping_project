/**
 * \brief Main for server execution. It should be initialized with at least 2 arguments (ipv4 default) and with 3 arguments for ipv6.
 * zserver/server ip_address number_of_messages type_of_ip (optional)
 * 
